	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="个人简介" prop="gerenjianjie">
					<editor 
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.gerenjianjie = this.ruleForm.gerenjianjie.replace(reg,'../../../ssmdki8hi7o/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
