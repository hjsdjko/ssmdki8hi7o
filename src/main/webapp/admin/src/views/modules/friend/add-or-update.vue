	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="表名" prop="tablename">
					<el-input v-model="ruleForm.tablename" placeholder="表名" clearable  :readonly="ro.tablename"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="表名" prop="tablename">
					<el-input v-model="ruleForm.tablename" placeholder="表名" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="别名" prop="alias">
					<el-input v-model="ruleForm.alias" placeholder="别名" clearable  :readonly="ro.alias"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="别名" prop="alias">
					<el-input v-model="ruleForm.alias" placeholder="别名" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="类型(0:好友申请，1:好友，2:消息)" prop="type">
					<el-input v-model.number="ruleForm.type" placeholder="类型(0:好友申请，1:好友，2:消息)" clearable  :readonly="ro.type"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="类型(0:好友申请，1:好友，2:消息)" prop="type">
