<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="病例编号" prop="binglibianhao">
					<el-input v-model="ruleForm.binglibianhao" placeholder="病例编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.binglibianhao" label="病例编号" prop="binglibianhao">
					<el-input v-model="ruleForm.binglibianhao" placeholder="病例编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="处方详情" prop="chufangxiangqing">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.chufangxiangqing" label="处方详情" prop="chufangxiangqing">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.chufangxiangqing}}</span>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="饮食建议" prop="yinshijianyi">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.yinshijianyi" label="饮食建议" prop="yinshijianyi">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.yinshijianyi}}</span>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="运动建议" prop="yundongjianyi">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="运动建议"
					  v-model="ruleForm.yundongjianyi" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.yundongjianyi" label="运动建议" prop="yundongjianyi">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.yundongjianyi}}</span>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="病例详情" prop="binglixiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.binglixiangqing" label="病例详情" prop="binglixiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.binglixiangqing"></span>
                </el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				binglixiangqing: [
					{ required: true, message: '病例详情不能为空', trigger: 'blur' },
				],
				chufangxiangqing: [
				],
				yinshijianyi: [
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.binglixiangqing = this.ruleForm.binglixiangqing.replace(reg,'../../../ssmdki8hi7o/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
