	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="药品分类" prop="yaopinfenlei">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="药品分类" prop="yaopinfenlei">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.yaopinshuoming = this.ruleForm.yaopinshuoming.replace(reg,'../../../ssmdki8hi7o/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
