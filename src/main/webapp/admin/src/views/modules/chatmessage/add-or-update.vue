<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="用户ID" prop="uid">
					<el-input v-model="ruleForm.uid" placeholder="用户ID" clearable  :readonly="ro.uid"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="用户ID" prop="uid">
					<el-input v-model="ruleForm.uid" placeholder="用户ID" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="好友用户ID" prop="fid">
					<el-input v-model="ruleForm.fid" placeholder="好友用户ID" clearable  :readonly="ro.fid"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="好友用户ID" prop="fid">
					<el-input v-model="ruleForm.fid" placeholder="好友用户ID" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="内容" prop="content">
					<el-input v-model="ruleForm.content" placeholder="内容" clearable  :readonly="ro.content"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="内容" prop="content">
					<el-input v-model="ruleForm.content" placeholder="内容" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="格式(1:文字，2:图片)" prop="format">
					<el-input v-model.number="ruleForm.format" placeholder="格式(1:文字，2:图片)" clearable  :readonly="ro.format"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="格式(1:文字，2:图片)" prop="format">
					<el-input v-model="ruleForm.format" placeholder="格式(1:文字，2:图片)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="消息已读(0:未读，1:已读)" prop="isread">
					<el-input v-model.number="ruleForm.isread" placeholder="消息已读(0:未读，1:已读)" clearable  :readonly="ro.isread"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="消息已读(0:未读，1:已读)" prop="isread">
