...
<div :style='{"width":"100%","padding":"100px 18% 60px","margin":"0px auto","position":"relative","background":"url(http://codegen.caihongy.cn/20231029/b89b677f7bba41d694305c19dc3b820d.jpg) no-repeat center top,#fff"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="预约编号" prop="yuyuebianhao">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="照片" v-if="type!='cross' || (type=='cross' && !ro.zhaopian)" prop="zhaopian">
            <file-upload
            tip="点击上传照片"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' class="upload" v-else label="照片" prop="zhaopian">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="挂号类型" prop="guahaoleixing">
            <el-select  @change="guahaoleixingChange" v-model="ruleForm.guahaoleixing" placeholder="请选择挂号类型">
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="挂号费用" prop="guahaofeiyong">
			<el-input-number v-model="ruleForm.guahaofeiyong" placeholder="挂号费用" :readonly="ro.guahaofeiyong"></el-input-number>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="预约时间" prop="yuyueshijian">
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="手机号码" prop="shoujihaoma">
            <el-input v-model="ruleForm.shoujihaoma" 
                placeholder="手机号码" clearable :disabled=" false  ||ro.shoujihaoma"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="病情描述" prop="bingqingmiaoshu">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/guahaoleixing/guahaoleixing', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.guahaoleixingOptions = res.data.data;
          }
        });
      ...
      // 下二随
      guahaoleixingChange () {
        this.$http.get('follow/guahaoleixing/guahaoleixing?columnValue=' + this.ruleForm.guahaoleixing, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            if(res.data.data.guahaofeiyong){
              this.ruleForm.guahaofeiyong = res.data.data.guahaofeiyong
            }
          }
        });
      },
